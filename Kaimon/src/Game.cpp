...
Game::Game(Window& window)
	...
	m_model("res/models/nanosuit/nanosuit.obj"),
	m_player(this, m_model, Vector3f(0.0f, 0.0f, 0.0f), Vector3f(0.0f, 0.0f, 0.0f), Vector3f(0.5f, 0.5f, 0.5f)),
	m_entityList { &m_player },
	m_updatableList { &m_camera, &m_frustum, &m_player },
	m_collideableList { &m_player },
